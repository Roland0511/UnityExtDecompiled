	...
	public class AnimationPlayableAsset : PlayableAsset, ITimelineClipAsset, IPropertyPreview
	{
		...
		public Quaternion rotation
		{
			...
			set
			{
				...
				if (PlayableExtensions.IsValid<AnimationOffsetPlayable>(this.m_AnimationOffsetPlayable))
				{
					this.m_AnimationOffsetPlayable.SetRotation(value);
				}
			}
		}
		...
		{
			this.m_AnimationOffsetPlayable = AnimationOffsetPlayable.get_Null();
			...
			if (this.applyRootMotion)
			{
				...
				this.m_AnimationOffsetPlayable = animationOffsetPlayable;
